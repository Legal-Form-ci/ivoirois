...
import appLogo from "@/assets/logo-full-dark.png";
import appLogoLight from "@/assets/logo-full-white.png";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/85 backdrop-blur-xl supports-[backdrop-filter]:bg-background/70">
      ...
      <div className="mx-auto flex h-14 md:h-16 max-w-screen-2xl items-center justify-between gap-3 px-3 sm:px-6">
        <Link to="/feed" aria-label="E'nvlé Space — Accueil" className="flex items-center shrink-0 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
          <img src={appLogo} alt="E'nvlé Space" className="h-9 sm:h-10 md:h-12 w-auto object-contain drop-shadow-sm dark:hidden" />
          <img src={appLogoLight} alt="" aria-hidden="true" className="hidden dark:block h-9 sm:h-10 md:h-12 w-auto object-contain drop-shadow-sm" />
        </Link>
